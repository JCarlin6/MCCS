...
$data = "<?php 
        ...
        class Database{
            private \$server = \"$MySQLServerAddress\";
            private \$user = \"$MySQLUsername\";
...
?>
        ...
        <?php 
            ...
            define('DB_SERVER', '$MySQLServerAddress'); 
        ...
        <?php
            if (!defined('DB_DATABASE')){
                ...
                define ('DB_DATABASE', \"$MySQLDB\");
                define ('DB_HOST', \"$MySQLServerAddress\");
        ...
        $fp = fopen("../lib/dbcontroller.php", 'w');
        fwrite($fp, $data);
        fclose($fp);
