  ...
  <form enctype="multipart/form-data" action="/setup/logic.php?" method="post" class="text-center" id="SQLForm">
    ...
    <div class="row">
      ...
      <div class="form-group col-4">
        ...
        <input type="text" class="form-control" id="MySQLUsername" aria-describedby="emailHelp" placeholder="My Username" value="">
      </div>
    </div>
    <div class="row">
      <div class="col-4"></div>
      <div class="form-group col-4">
        ...
        <input type="password" class="form-control" id="MySQLPassword" aria-describedby="emailHelp" placeholder="********" value="">
      </div>
    </div>
