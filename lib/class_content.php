...
class Content{
    ...
    public function DenyWOItemCall($WorkOrderID){
        ...
        $ToList[] = "$Email";
        $body = " $FirstName, <br /><br /> A WorkOrder has been <u>declined</u> by: $POIFName $POILName under WorkOrder: $WorkOrderID. <br /><br /> Please visit the referenced WorkOrder by clicking this <a href=\"http://10.162.0.40/default.php?do=workorders&action=view&workorderid=$WorkorderID\">link</a><br /><br />  Thank you. ";
    ...
    public function CreateInventoryData(){        
        ...
        public function CreatePMData(){
            ...
            foreach($WorkChecklist AS $ChecklistItem){
                ...
                echo "test";
                        ...
                        $body = " Team, <br /><br /> A PM has been created by: $Username under PM: $lastid. <br /><br /> Please visit the referenced PM by clicking this <a href=\"http://10.162.0.40/default.php?do=workorders&action=viewpm&pmid=$lastid\">link</a><br /><br />  Thank you. ";
                        $body = $this->MailNotice($body);
        ...
        public function CreateWorkorderData(){
            ...
            $body = " Team, <br /><br /> A WorkOrder has been manually generated by: $Username under WorkOrder: $lastid. <br /><br /> Please visit the referenced WorkOrder by clicking this <a href=\"http://10.162.0.40/default.php?do=workorders&action=view&workorderid=$WorkorderID\">link</a><br /><br />  Thank you. ";
            $body = $this->MailNotice($body);
            $MailSubject = "System WorkOrder Generated";
            $this->InternaltoExternalMailCall($body, $MailSubject, $ToList);
        ...
        public function UpdateWorkorderData(){
            ...
            if(!empty($_POST["WorkNotes"])){
                ...
                if($EmailActive == True){
                    $body = " $FirstName, <br /><br /> Notes have been added to WorkOrder by: $POIFName $POILName under WorkOrder: $WorkOrderID. <br /><br /> Please visit the referenced WorkOrder by clicking this <a href=\"http://10.162.0.40/default.php?do=workorders&action=view&workorderid=$WorkorderID\">link</a><br /><br />  Thank you. ";
                    $body = $this->MailNotice($body);
            ...
            if(($_POST["Status"] == '11') AND ($OriginalStatus <> '11') AND ($_POST["AssignmentType"] != '10')){
                ...
                $POILName = $UsernameArray[1];
                $ToList[] = "$Email";
                $body = " $FirstName, <br /><br /> A WorkOrder has been <u>closed</u> by: $POIFName $POILName under WorkOrder: $WorkOrderID. <br /><br /> Please visit the referenced WorkOrder by clicking this <a href=\"http://10.162.0.40/default.php?do=workorders&action=view&workorderid=$WorkorderID\">link</a><br /><br />  Thank you. ";
                $body = $this->MailNotice($body);
                $MailSubject = "System WorkOrder Closed";
                $this->InternaltoExternalMailCall($body, $MailSubject, $ToList);
            }
